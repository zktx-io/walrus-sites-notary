...
export const Home = () => {
  ...
  return (
    <div className="relative flex min-h-screen flex-col overflow-hidden px-4 text-white">
      <BackgroundFx />
      <Navbar />

      <main className="z-10 flex flex-1 flex-col items-center justify-center py-12 text-center">
